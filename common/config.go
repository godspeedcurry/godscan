...
var DirList = []string{"/", ".git/index", ".git/HEAD", "swagger-resources", "v2/api-docs", "admin", "nacos", "xxl-job-admin", ".DS_Store", ".svn", "actuator", "actuator/env", "api/swagger-ui.html", "geoserver/index.html", "jeecg-boot", "nacos/#/", "site.tar.gz", "www.tar.gz", "web.tar.gz"}
